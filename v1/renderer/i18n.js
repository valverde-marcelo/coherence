...
window.coherenceI18n = {
  dictionaries: {
    'pt-BR': {
      ...
      recoveringIdentity: 'Procurando seeders para recuperar seu perfil, posts e seguidores…',
      recoveryExpired: 'Nenhum seeder encontrado dentro do prazo. Você pode tentar novamente ou começar do zero.',
      ...
      faqItems: [
        ...
        ['Posso recuperar minha conta em outro dispositivo?', 'Sim. Importe apenas o identity.json. Um seeder precisa estar online para recuperar perfil, posts e seguidores; sem seeder, após o timeout você pode começar do zero.'],
    ...
    'en-US': {
      ...
      recoveringIdentity: 'Looking for seeders to recover your profile, posts and followers…',
      recoveryExpired: 'No seeder was found in time. You can try again or start from zero.',
      ...
      faqItems: [
        ...
        ['Can I recover my account on another device?', 'Yes. Import only identity.json. A seeder must be online to recover your profile, posts and followers; without one, you can start from zero after the timeout.'],

...
window.coherenceI18n = {
  dictionaries: {
    ...
    'en-US': {
      ...
      aboutProject: 'project', aboutDescription: 'A decentralized social network based on Hypercore.', aboutVersion: 'version', aboutGithub: 'GitHub repository', aboutStackTitle: 'technology', donationCaption: 'Support development', donatePaypal: 'donate via PayPal', checkForUpdates: 'check for updates', checkingForUpdates: 'Checking for updates…', updateAvailable: 'New version {version} available!', updateDownload: 'download', updateUpToDate: 'You are on the latest version ({version}).', updateCheckError: 'Could not check for updates right now.',

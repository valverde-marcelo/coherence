  ...
  dictionaries: {
    'pt-BR': {
      ...
      faqItems: [
        ...
        ['O que acontece se eu perder minhas chaves?', 'Suas chaves são a única forma de acessar sua conta. Recomendamos fazer backup do arquivo identity.json.'],
        ...
        ['Posso usar o Coherence em vários dispositivos?', 'Sim, copie o arquivo identity.json e o diretório de dados para o outro dispositivo.'],
    ...
    'en-US': {
      ...
      faqItems: [
        ...
        ['What happens if I lose my keys?', 'Your keys are the only way to access your account. We recommend backing up identity.json.'],
        ...
        ['Can I use Coherence on multiple devices?', 'Yes, copy identity.json and the data directory to the other device.'],

...
window.coherenceI18n = {
  dictionaries: {
    'pt-BR': {
      ...
      recoveryExpired: 'Ainda procurando um seeder. Você pode continuar aguardando ou começar do zero.',
    ...
    'en-US': {
      ...
      recoveryExpired: 'Still looking for a seeder. You can keep waiting or start from zero.',
